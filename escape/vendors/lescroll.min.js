var leScroll = function (e) {
    ...
    return e.scroll = !1, e.move = function () {
        document.getElementById("mask-main").style.top = i ? "-" + t * n + "px" : "-" + t * window.innerHeight + "px"
    }, e.moveUp = function () {
        0 !== t && (t--, e.move())
    }, e.moveDown = function () {
        t !== o && (t++, e.move())
...
!function (e, t, o) {
    ...
    for (var n = t.getElementsByTagName("li"), i = {up: 38, down: 40}, l = function (t) {
        ...
        o.scrolling || (e > 0 ? (o.scrolling = !0, o.moveUp(), o.setScrollTimeout(200)) : 0 >= e && (o.scrolling = !0, o.moveDown(), o.setScrollTimeout(200)))
    }, r = function () {
